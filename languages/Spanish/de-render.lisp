...
(defmethod de-render ((utterance string) (mode (eql :spanish-hybrid))
                      &key (key :spanish) cxn-inventory (model "es") &allow-other-keys)
  ...
  (multiple-value-bind (basic-transient-structure dependency-tree)
    ...
    (setf basic-transient-structure
          (represent-functional-structure 
           dependency-tree basic-transient-structure key *spanish-fcg-categories*))
