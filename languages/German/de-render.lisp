...
(defmethod de-render ((utterance string) (mode (eql :german-hybrid))
                      &key (key :german) cxn-inventory (model "de") &allow-other-keys)
  ...
  (multiple-value-bind (basic-transient-structure dependency-tree)
    ...
    (setf basic-transient-structure
          (represent-functional-structure 
           dependency-tree basic-transient-structure key *german-fcg-categories*))
